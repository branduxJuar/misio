...
import { Card, Button, Table, Typography, Space, message, Modal, Form, Input, Select, InputNumber, Row, Col, Tag, Switch, DatePicker } from 'antd';
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          <Title level={2} style={{ margin: 0 }}><RocketOutlined /> Promociones y Campañas</Title>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleCreate}>
          ...
          <Card type="inner" title={<><UsergroupAddOutlined /> Filtros de Audiencia</>} style={{ marginBottom: 24 }}>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255,255,255,0.08)', padding: 16, borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
              ...
              <Space>
                {audienceCount !== null && (
                  <Tag color="blue" style={{ fontSize: 16, padding: '4px 12px' }}>{audienceCount} usuarios</Tag>
                )}
                <Button onClick={calculateAudience} loading={calculating}>Calcular</Button>
              </Space>
            </div>
          </Card>
